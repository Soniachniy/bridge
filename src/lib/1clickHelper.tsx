...
export const CHAIN_ICON: Record<TokenResponse.blockchain | string, string> = {
  ...
  [TokenResponse.blockchain.ARB]: "/networks/arbitrum.svg",
  [TokenResponse.blockchain.GNOSIS]: "/networks/gnosis.png",
  [TokenResponse.blockchain.BERA]: "/networks/bera.png",
  [TokenResponse.blockchain.BSC]: "/networks/bsc.svg",
  [TokenResponse.blockchain.POL]: "/networks/polygon.png",
  [TokenResponse.blockchain.SOL]: "/networks/solana.svg",
  [TokenResponse.blockchain.BTC]: "/networks/bitcoin.png",
  [TokenResponse.blockchain.TON]: "/networks/ton.svg",
  [TokenResponse.blockchain.DOGE]: "/networks/doge.png",
